    ...
    public class KethaneDebugger : Part
    {
        ...
        private void DrawDebugMap()
        {
            if (vessel.mainBody != null)
            {
                ...
                List<Deposit> Deposits = KethaneController.PlanetDeposits[KethaneController.SelectedResource][this.vessel.mainBody.name];
        ...
        private void DebugWindowGUI(int windowID)
        {
            ...
            var DepositUnder = controller.GetDepositUnder(KethaneController.SelectedResource);
